...
public class AlignWithRightReefCommand extends Command {
  private DriveSubsystem m_driveSubsystem;
  private final AprilTagPID m_AprilTagPID;
  private double m_targetZ = 0.5; // fwd backward
  private double m_targetX = -0.18; // left to right -.15
  ...
  public AlignWithRightReefCommand(DriveSubsystem driveSubsystem, AprilTagPID aprilTagPID) {
