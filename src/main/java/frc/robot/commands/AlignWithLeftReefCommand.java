...
public class AlignWithLeftReefCommand extends Command {
  private DriveSubsystem m_driveSubsystem;
  private final AprilTagPID m_AprilTagPID;
  private double m_targetZ = 0.5; // fwd backward
  private double m_targetX = 0; // left to right .17
  ...
  public AlignWithLeftReefCommand(DriveSubsystem driveSubsystem, AprilTagPID aprilTagPID) {
